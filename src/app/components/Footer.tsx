        ...
        <div className="flex flex-col md:grid md:grid-cols-3 gap-8 items-center md:items-start text-center md:text-left">
          ...
          <div className="md:col-span-2 min-w-0 flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-wrap space-x-4 justify-center md:justify-start">
              <a href="https://halilyesilyurt.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-100 rounded-lg flex items-center justify-center text-slate-600 hover:bg-blue-100 hover:text-blue-600 transition-colors duration-200 cursor-pointer">
              ...
              <a href="https://www.linkedin.com/in/halilyesilyurt/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-100 rounded-lg flex items-center justify-center text-slate-600 hover:bg-blue-100 hover:text-blue-600 transition-colors duration-200 cursor-pointer">
              ...
              <a href="https://github.com/halil-yesilyurt" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-slate-100 rounded-lg flex items-center justify-center text-slate-600 hover:bg-blue-100 hover:text-blue-600 transition-colors duration-200 cursor-pointer">
              ...
              <a href="mailto:hi@halilyesilyurt.com" className="w-10 h-10 bg-slate-100 rounded-lg flex items-center justify-center text-slate-600 hover:bg-blue-100 hover:text-blue-600 transition-colors duration-200 cursor-pointer">
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/about" className="text-slate-600 hover:text-blue-600 transition-colors duration-200 cursor-pointer">About</Link>
              </li>
              <li>
