...
export default function SocialMediaLinks({ variant = 'footer', className = '' }: SocialMediaLinksProps) {
  const socialLinks = [
    {
      name: 'Twitter',
      url: 'https://twitter.com/haliilyesilyurt',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/halilyesilyurt/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'GitHub',
      url: 'https://github.com/halil-yesilyurt',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'Email',
      url: 'mailto:hi@halilyesilyurt.com',
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div className={`${baseClasses} ${className}`}>
      {socialLinks.map((link) => (
        <a
          ...
          className={`${linkClasses} ${link.color} cursor-pointer`}
