          ...
          <div className="max-w-4xl mx-auto text-center py-16">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                ...
                <h3 className="font-semibold text-slate-900 mb-2">Full-Text Search</h3>
                <p className="text-sm text-slate-600">Search across titles, content, and excerpts</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                ...
                <h3 className="font-semibold text-slate-900 mb-2">Smart Filters</h3>
                <p className="text-sm text-slate-600">Filter by category, tags, and date</p>
              </div>
              <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
                ...
                <p className="text-sm text-slate-600">Get instant search results with pagination</p>
              </div>
            </div>
          </div>
        </main>
